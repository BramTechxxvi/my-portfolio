                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground">
                            ...
                            RESTful APIs, working with relational and non-relational databases, 
                            and optimizing backend architectures to support modern applications.
                        </p>
                        ...
                        <div className="gradient-border p-6 card-hover">
                            <div className="flex items-start gap-4"> 
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-muted-foreground">
                                        Designing and maintaining scalable RESTful and GraphQL APIs 
                        ...
                        <div className="gradient-border p-6 card-hover">
                            <div className="flex items-start gap-4"> 
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-muted-foreground">
                                        Skilled in SQL and NoSQL databases, ensuring data is structured, 

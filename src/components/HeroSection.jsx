            ...
            <div className="container max-w-6xl mx-auto z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <div className="flex-1 flex justify-center md:justify-end items-center">
                    <img 
                        src="/usage.JPG" 
                        alt="Ibrahim" 
                        className="w-60 h-60 md:w-96 md:h-96 object-cover rounded-full shadow-lg opacity-0 animate-fade-in-delay-2 transform transition duration-700 hover:scale-105" 
                    />
                </div>
            </div>
            <div 
